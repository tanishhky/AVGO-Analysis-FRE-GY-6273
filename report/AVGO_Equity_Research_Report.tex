...
\textbf{Result.} The base-case DCF implies a price of \$436 per share (9.0\% upside), with the WACC$\times$g sensitivity producing a \$402--\$474 range at $\pm$100bps WACC and base terminal growth.
...
The methods cluster within a defensible \$400--\$510 range. Our December-2026 price target of \$475 sits modestly above the Street median (\$460) and roughly at the Monte Carlo mean (\$471)---a level consistent with FY27 AI revenue printing in the \$120--130B range (where management's ``\$100B+'' floor and Street upper-bound converge).
