...
%   at ([xshift=0.6in,yshift=-1.58in]current page.north west) {25 April 2026};
...
\node[anchor=north east,text=white,font=\fontsize{22}{28}\bfseries,inner sep=0pt]
  at ([xshift=-0.6in,yshift=-1.50in]current page.north east) {\$422.76};
\node[anchor=north east,text=accentgreen!70!white,font=\fontsize{10}{13}\bfseries\sffamily,inner sep=0pt]
  at ([xshift=-0.6in,yshift=-1.80in]current page.north east) {\(\blacktriangle\) +32.6\% (30D) \quad +121.6\% (12M)};
...
The mean PT of the eleven covering firms in our dataset is \$449; the median is \$460. Eight of eleven sit above the current spot price.

\begin{figure}[!ht]
\centering
\includegraphics[width=\textwidth]{fig12_analyst_pts.png}
\caption{Sell-side price-target distribution. Median \$460; 8 of 11 firms above spot. Source: Benzinga, individual broker reports.}
\end{figure}
...
\textbf{Result.} The base-case DCF implies a price of \$436 per share (3.1\% upside), with the WACC$\times$g sensitivity producing a \$402--\$474 range at $\pm$100bps WACC and base terminal growth.
...
The 60.7\% probability that intrinsic value exceeds spot, combined with $E[\text{intrinsic}] = \$471$ vs.\ spot of \$422.76, supports our BUY rating.
...
After a 121.6\% twelve-month run, our DCF, SOTP, and comps cluster at \$400--440, but our Monte Carlo (calibrated to the Street consensus FY27 AI midpoint of \$125B) gives a 60.7\% probability of upside vs.\ spot with $E[\text{intrinsic}] = \$471$. We initiate at BUY with a \$475 December-2026 price target, equivalent to 12\% upside and modestly above the Street median (\$460). We would consider further upgrading our PT on a positive print to FY27 AI revenue scale at the December 2026 guide.
